...
import { SetNewPasswordUserRequest, SetNewPasswordUserResponse, setNewPasswordUser } from 'api';
import { MessageType, antdMessage } from 'components';

export const useSetNewPassword = (): UseMutationResult<SetNewPasswordUserResponse, Error, SetNewPasswordUserRequest> =>
