...
export const useRegister = (): UseMutationResult<RegisterUserResponse, Error, RegisterUserRequest> =>
  useMutation(registerUser, {
    onSuccess: () => {
      antdMessage({ type: MessageType.SUCCESS, content: 'User has been registered' });
    },
    onError: () => {
